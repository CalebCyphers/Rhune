...
function renderPlaybookEmbed(record) {
	...
	const embed = new EmbedBuilder()
		...
		.addFields(
			{ name: 'Backgrounds', value: Object.keys(pb.backgrounds).map(b => `• ${b}`).join('\\n'), inline: false },
			{ name: 'Starting Moves', value: Object.keys(pb.startingMoves).map(m => `• ${m}`).join('\\n'), inline: false },
			{ name: 'Instincts', value: Object.entries(pb.instincts).map(([k, v]) => `• **${k}** — ${v}`).join('\\n'), inline: false },
		)
...
module.exports = { lookupPlaybook, renderPlaybookEmbed, getAllMoves };
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Spirit Tongue**, **Call the Spirits**, 1 from your Background, and 1 of your choice.*', die: 'd6', maxHP: 18 },
};
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Ambush** OR **Skill at Arms**; **Danger Sense** OR **Perceptive**; and 1 of your choice.*', die: 'd6', maxHP: 16 },
};
playbooks.Fox = Fox;
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Dangerous**, **Hard to Kill**, and either **Armored** OR **Uncanny Reflexes**.*', die: 'd6', maxHP: 20 },
};
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Censure**, **Chronicler of Stonetop**, plus 2 more of your choice.*', die: 'd6', maxHP: 20 },
};
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Consecrated Flame** and **Invoke the Sun God**, plus 1 more of your choice.*', die: 'd6', maxHP: 18 },
};
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Crew**, **Logistics**, any moves from your Background, and 1 move of your choice.*', die: 'd6', maxHP: 20 },
};
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Home on the Range**, any moves from your Background, plus 1 of your choice.*', die: 'd6', maxHP: 18 },
};
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Well Versed**, **Work With What You\'ve Got**, plus 1 from your Background.*', die: 'd6', maxHP: 16 },
};
...
---`, starred: false },
	...
	creationRules: { intro: '*You start with **Anger Is a Gift**, **Potential for Greatness**, and 2 other moves of your choice.*', die: 'd6', maxHP: 16 },
};
